...
[RegEx regular expression](./docs/regex.md)<!--rehype:style=background: rgb(149 36 155);-->
...
[HTTP status code](./docs/http-status-code.md)<!--rehype:style=background: rgb(16 185 129);-->
[HTML character entity](./docs/html-char.md)<!--rehype:style=background: rgb(16 185 129);&class=tag&data-lang=HTML-->
